...
function claims() {
  return (
    <section className='mt-8 flex flex-col justify-center items-center'>
      <h2 className='text-3xl text-center font-semibold text-[#ED3237]'>Claims</h2 >
      ...
      <h3 className='text-3xl mt-8 text-center font-semibold text-[#ED3237]'>Procedure to Settle Claims</h3>
